  ...
  return (
    <article className="font-rubik pb-8">
      <div className="w-full max-w-[960px] mx-auto sm:flex sm:justify-center sm:items-center">
        <div className="relative my-6 py-10 h-[450px] max-w-[350px] text-center mx-auto">
        ...
        <div className="w-full relative my-6 py-10 h-[450px] max-w-[350px] text-center mx-auto">
