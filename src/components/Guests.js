...
const Guests = () => {
  return (
    <article className="font-rubik pb-8">
      <div className="w-full min-[650px]:flex min-[650px]:justify-center items-center">
        <div className="relative my-6 py-10 h-[450px] max-w-[300px] text-center mx-auto">
        ...
        <div className="w-full relative my-6 py-10 h-[450px] max-w-[300px] text-center mx-auto">
