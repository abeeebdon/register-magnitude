...
const Section1 = () => {
  return (
    <div className="bg-blue-300 sm:bg-gradient-to-br from-white to-blue-200">
      <div className="max-w-[1100px] mx-auto flex flex-col relative ">
        ...
        <div className="sm:bg-blue-950  p-6 text-white md:w-[80%] lg:mt-10 max-w-[900px] lg:text-left sm:mx-auto lg:pt-8 lg:mr-[2%] ">
