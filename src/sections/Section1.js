const Section1 = () => {
  return (
    <div className="relative basis-[47%] bg-blue-100 sm:bg-transparent pt-4">
      ...
      <div className="w-full sm:mt-10 mx-2 h-full my-auto flex items-center text-white">
        <div className="bg-blue-950 sm:rounded-lg py-4 sm:pt-[4rem] sm:px-4 mt-10 pb-8 ">
