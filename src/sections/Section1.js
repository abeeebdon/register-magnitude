  ...
  return (
    <div className="py-8">
      <div className="max-w-[1100px] mx-auto flex flex-col relative ">
        <div className="w-fit border-[1rem] border-white rounded-full bg-[rgb(85,78,200)] p-4 mx-auto my-4 sm:h-fit lg:absolute   top-[10%]">
          <p className=" text-white text-center mx-auto font-bold px-4 py-10 text-[1.4rem] sm:text-[1.5rem] ">
            21ST CENTURY <br /> DIGITAL CORPS
            <br /> CONFERENCE
          </p>
        </div>
