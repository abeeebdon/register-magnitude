...
const Section1 = () => {
  return (
    <div className=" my-8 p-4 mx-auto w-full max-w-[750px] relative sm:flex flex-row">
      <div className="w-fit border-[1rem] border-white rounded-full bg-blue-950 p-6 mx-auto absolute top-[-18%] right-0 left-0">
        <p className=" text-white mx-auto font-bold px-4 py-10 text-[1.4rem] sm:text-[2rem]">
          The Youth <br />
          Social Summit
          <br /> Nigeria
        </p>
      ...
      <div className=" bg-blue-950 text-white pt-14 pb-8 p-4 mt-[4rem] ">
        <div className="mt-8">
          <p className="w-full max-w-[700px] mx-auto px-[1rem] pt-[1.4rem] sm:pt-[5rem] text-[1.2rem]">
