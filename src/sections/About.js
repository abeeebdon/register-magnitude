  ...
  return (
    <div className="basis-[50%] pt-8 max-w-[550px]">
      ...
      <p className="py-4 my-4">
        ...
        scelerisque, non scelerisque tortor facilisis. Sed luctus libero eget
        odio dictum, nec tempus enim tincidunt. Nulla euismod nisi vitae justo
        sodales, nec pellentesque tortor lobortis. Curabitur vulputate volutpat
        ligula non elementum. Fusce vehicula nulla nec metus eleifend, nec
